module.exports.chatReplacements = [
	...
	},
	{
		...
		regex: /^mod.support/i,
		replacement:
			'The  most effective way to contact a mod is talk to your leaders. Provide game links and images when possible.',
		aemCooldown: 15,
		normalCooldown: 180,
		normalGames: 50
	},
	{
		...
		regex: /^v.eto/i,
		replacement:
			'Veto is unlocked after the 5th bam card is played. This power allows for the resulting policy to be played to be nullified- but only if both the president and chancellor vote "ja". If either votes "nein", the resulting policy will be enacted as usual.',
		aemCooldown: 15,
		normalCooldown: 180,
		normalGames: 50
	},

...
if (process.env.NODE_ENV !== 'production') {
	...
	store = new MongoDBStore({
		uri: 'mongodb://localhost:27017/its-always-bob-app',
		collection: 'sessions'
	});
} else {
...
mongoose.connect(`mongodb://localhost:27017/its-always-bob-app`, { useNewUrlParser: true, useUnifiedTopology: true });
